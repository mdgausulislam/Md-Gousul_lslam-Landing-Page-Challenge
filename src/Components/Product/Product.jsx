        ...
        <div className='lg: container mx-auto py-5 px-4 lg:px-28'>
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className="join join-vertical lg:join-horizontal">
                    <button className="btn join-item" onClick={() => handleFilterChange('latest')}>Latest</button>
                    <button className="btn join-item" onClick={() => handleFilterChange('special')}>Special</button>
                    <button className="btn join-item" onClick={() => handleFilterChange('bestseller')}>Best Seller</button>
                </div>
            </div>
